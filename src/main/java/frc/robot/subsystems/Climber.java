...
public class Climber extends SubsystemBase {
    ...
    private static void configurePidController(SparkMaxPIDController controller) {
        ...
        controller.setOutputRange(-Constants.Climber.Down.outputRange, Constants.Climber.Down.outputRange, Constants.Climber.Down.PIDslot);
        ...
        controller.setOutputRange(-Constants.Climber.Up.outputRange, Constants.Climber.Up.outputRange, Constants.Climber.Up.PIDslot);
    ...
    private void updateSoftLimitPosition(){
        this._rightSparkMax.setSoftLimit(SoftLimitDirection.kReverse, (float) SmartDashboard.getNumber("soft limit reverse", Constants.Climber.startingPosition));
        this._rightSparkMax.setSoftLimit(SoftLimitDirection.kForward, (float) SmartDashboard.getNumber("soft limit forward", Constants.Climber.climbExtentionHeight));
        this._leftSparkMax.setSoftLimit(SoftLimitDirection.kReverse, (float) SmartDashboard.getNumber("soft limit reverse", Constants.Climber.startingPosition));
        this._leftSparkMax.setSoftLimit(SoftLimitDirection.kForward, (float) SmartDashboard.getNumber("soft limit forward", Constants.Climber.climbExtentionHeight));
    }
    ...
    private void updateSDB() {
        ...
        // SmartDashboard.putNumber("right encoder pos", SmartDashboard.getNumber("right encoder pos", Constants.Climber.startingPosition));
        // SmartDashboard.putNumber("left encoder pos", SmartDashboard.getNumber("left encoder pos", Constants.Climber.startingPosition));
    }
    ...
    private static void updateController(SparkMaxPIDController controller) {
        ...
        controller.setOutputRange(-SmartDashboard.getNumber("output range up", Constants.Climber.Up.outputRange),
                SmartDashboard.getNumber("output range up", Constants.Climber.Up.outputRange), Constants.Climber.Up.PIDslot);
    }
