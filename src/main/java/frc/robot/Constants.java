...
public final class Constants {
    public static final class ArmConstants {
        ...
        //Arm gains
        public static final double startingRad = -7*(2*Math.PI)*gearRatioNeoToArm; 
        ...
        public static final double gravityFF = (0.45 * 1 * 9.8) / (2.7 * 2 * 33.6) * 12;  // (required torque at 90 deg) / (max torque at 12v) * 12 volts
        ...
        public static final double shootAngle = -15; 
        //torque gains
