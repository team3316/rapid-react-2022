    ...
    public static final class Drivetrain {
        public static class SwerveModuleConstants {
            ...
            public SwerveModuleConstants(Translation2d position, int idDrive, int idSteering, double cancoderZeroAngle,int canCoderId) {
                this(position, idDrive, idSteering, new PIDFGains(0.0002, 0, 0.01, 0.0001848, 0, 0), new PIDFGains(0.35, 0.0, 0, 0, 0, 0), cancoderZeroAngle, canCoderId);
            }
        ...
        private static final double frontWheelDistMeters = 0.6703;
        private static final double sideWheelDistMeters = 0.5102;

        public static final SwerveModuleConstants TLModule = new SwerveModuleConstants(new Translation2d(-sideWheelDistMeters/2, frontWheelDistMeters/2), 3, 4, 188.8, 11);
        public static final SwerveModuleConstants TRModule = new SwerveModuleConstants(new Translation2d(sideWheelDistMeters/2, frontWheelDistMeters/2), 1, 2, 122.3, 10);
        public static final SwerveModuleConstants BLModule = new SwerveModuleConstants(new Translation2d(-sideWheelDistMeters/2, -frontWheelDistMeters/2), 5, 6, 290.4, 12);
        public static final SwerveModuleConstants BRModule = new SwerveModuleConstants(new Translation2d(sideWheelDistMeters/2, -frontWheelDistMeters/2), 7, 8, 143.0, 13);
