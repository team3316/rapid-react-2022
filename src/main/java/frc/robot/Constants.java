...
public final class Constants {
    public static final class ArmConstants {
        ...
        // Arm motion
        public static final double intakeAngle = 36 + 1; // in Degrees: measured. Theoretical was -37.6
    ...
    public static final class Manipulator {
        ...
        public static final double maxAccelerationSeconds = 0.5;
    ...
    public final class Climber {
        ...
        public static final double upMotorPercentage = 1;
        public static final double downMotorPercentage = -0.5;
